            ...
            <DocSubSection id="key-object" title="Key Object Fields">
              <Table
                ...
                rows={[
                  ...
                  [<InlineCode key="f5">valueMask</InlineCode>, "string", <>Masked key preview (e.g. <InlineCode>sk-p••••••••tion</InlineCode>). Present when <InlineCode>value</InlineCode> is not returned.</>],
